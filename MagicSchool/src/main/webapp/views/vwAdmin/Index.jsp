...
<jsp:attribute name="css">
    ...
    <div style="position: relative">
        ...
        <div class="edit-window-magic-school delete-cat-window-magic-school"
            ...
            <form method="post" action="#" class="d-flex justify-content-between w-100 h-100"
                  style="flex-direction: column;">
                ...
                <button class="btn p-3 bg-light text-info" type="submit" formaction="${pageContext.request.contextPath}/Admin/DeleteCategory"
        ...
        <div class="edit-window-magic-school delete-course-window-magic-school"
            ...
            <form method="post" action="#" class="d-flex justify-content-between w-100 h-100"
                ...
                <p class="color-lightgray-magic-school border-0 p-3 p-cat-name-magic-school"
                   style="border-radius: 50px;background-color: white;"></p>
                <button class="btn p-3 bg-light text-info" type="submit" formaction="${pageContext.request.contextPath}/Admin/DeleteCourse"
                        style="border-radius: 50px; font-weight: bold;">
                    Delete
                </button>
            </form>
        ...
        <div class="edit-window-magic-school delete-teacher-window-magic-school"
            ...
            <form method="post" class="d-flex justify-content-between w-100 h-100"
                ...
                <p class="color-lightgray-magic-school border-0 p-3 p-cat-name-magic-school"
                   style="border-radius: 50px;background-color: white;"></p>
                <button class="btn p-3 bg-light text-info" type="submit" formaction="${pageContext.request.contextPath}/Admin/DeleteTeacher"
                        style="border-radius: 50px; font-weight: bold;">
                    Delete
                </button>
