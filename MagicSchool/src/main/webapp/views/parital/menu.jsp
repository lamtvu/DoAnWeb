<nav class="top-bar-magic-school d-flex align-items-center shadow-magic-school ">
    ...
    <div class="dropdown-magic-school h-100">
        ...
        <ul class="dropdown-content-magic-school list-unstyled" style="width:250px;height:600px;top:70px">
            <li class="dropdown-magic-school">
                <a class="menu-text-magic-school dropdown-title-magic-school" href="#">Development</a>
                <i class="fa fa-angle-right" aria-hidden="true"></i>
                <ul class="dropdown-content-left-magic-school list-unstyled" style="width:250px;height:600px;">
                    <li>
                        <a class="menu-text-magic-school" href="#">Web development<a>
                    </li>
                    <li>
                        <a class="menu-text-magic-school" href="#">Date Science</a>
                    </li>
                </ul>
            </li>
            <li class="dropdown-magic-school">
                <a href="#" class="dropdown-title-magic-school menu-text-magic-school">Design</a>
                <i class="fa fa-angle-right" aria-hidden="true"></i>
                <ul class="dropdown-content-left-magic-school list-unstyled" style="width:250px;height:600px;">
                    <li><a class="menu-text-magic-school" href="#">Web Design</a></li>
                    <li><a class="menu-text-magic-school" href="#">Graphics Design & Illustration</a></li>
                </ul>
            </li>
        </ul>
    </div>
    <div class=" border-normal-magic-school h-75 ml-3 mr-3 bg-lightgray-magic-school"
         style="border-radius:50px; width: 60%;">
    ...
    <div style="margin-left:auto; margin-right:20px;" class="d-flex justify-content-center">
        <a class="btn-blue-magic-school p-2 m-1" style="width:80px; font-weight: 700;" href="#">Sign Up</a>
        <a class="btn-blue-magic-school p-2 m-1" style="width:70px; font-weight: 700;" href="#">Sign In</a>
    </div>
</nav>
<div class="container-lg-magic-school background-magic-school d-flex flex-wrap" style="height: 400px;">
    <div class="circle-1">&nbsp;
    </div>
    <div class="circle-2 d-flex" style="left:-100px; bottom:-100px">&nbsp;
        <div class="circle-0" style="top:-200px; left: 200px"></div>
        <div class="circle-1" style="left: -50px;"></div>
    </div>
    <i class="fa fa-html5 icon-float-magic-school" aria-hidden="true"></i>
    <i class="fa fa-css3 icon-float-magic-school" style="animation-delay: 2s;"></i>
    <i class="fa fa-code icon-float-magic-school" style="animation-delay:1s;"aria-hidden="true"></i>
    <div class="circle-0" style="top: 500px; animation-duration: 20s;"></div>
    <i class="fa fa-camera icon-float-magic-school" style="animation-delay:10s; left: 100px"aria-hidden="true"></i>
    <i class="fa fa-terminal icon-float-magic-school" style="animation-delay:5s;animation-duration:10;"aria-hidden="true"></i>
    <div class="billboard-magic-school d-flex justify-content-center flex-wrap"
         style="width:450px;height:280px;top:100px;left:15%; align-content: center;">
